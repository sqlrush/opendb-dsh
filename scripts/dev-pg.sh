...
docker exec opendb-dsh-pg psql -U dsh -d dsh -tAc "CREATE DATABASE dsh_test" >/dev/null 2>&1 || true
echo "PG_URL=postgres://dsh:dsh@127.0.0.1:5434/dsh_test   # tests"
echo "OPENDB_PG_URL=postgres://dsh:dsh@127.0.0.1:5434/dsh  # local host/runtime"
