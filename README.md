...
- 详细设计：[docs/2026-08-16-opendb-dsh-platform-design.md](docs/2026-08-16-opendb-dsh-platform-design.md)（v0.6，含 dsh rc.6 全部 195 个插件包的迁移清单、产品模型、记忆/知识/时序子系统与 P0 计划）

## 状态

设计已定稿到 v0.6，P0 可行性验证进行中（Host 派发 + Runtime 接力）。
